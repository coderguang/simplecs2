...
int DBConnections::ExitLanuch(int id){
					...
					return MyQuery(LANUCH,ssql,nullptr);
...
int DBConnections::InsertResult(struct strResultAll &resultA){ 
...
//for getResult
int DBConnections::GetResult(int resultID,struct strResultAll &resultA){
